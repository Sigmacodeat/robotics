...
export const chapters: Chapter[] = [
  ...
  { id: 5, slug: 'finance', title: 'Finance', titleKey: 'finance', requiredFields: ['capital','funding','roi','forecast'], subchapters: [
    ...
    { id: 'revenueVsCost', titleKey: 'headings.revenueVsCost', title: 'Revenue vs. Cost' },
    { id: 'cashFlow', titleKey: 'finance.cashFlow', title: 'Cash Flow' },
    { id: 'profitBridge', titleKey: 'finance.profitBridge', title: 'Profit Bridge' },
    { id: 'ebitda', titleKey: 'headings.plOverview', title: 'EBITDA' },
    { id: 'revenueForecast', titleKey: 'headings.projections', title: 'Revenue Forecast' },
    { id: 'revenueTable', titleKey: 'headings.revenueComposition', title: 'Revenue Table' },
    { id: 'fundraising', titleKey: 'headings.fundraising', title: 'Fundraising' },
    { id: 'capTable', titleKey: 'sections.capTable', title: 'Cap Table' },
    { id: 'projections', titleKey: 'headings.projections', title: 'Projections' },
    { id: 'submissionsPlan', titleKey: 'headings.submissionsPlan', title: 'Submission Plan' },
    { id: 'fundingSummary', titleKey: '', title: 'Funding Summary' },
  ] },
