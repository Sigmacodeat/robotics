...
export type ChapterProps = {
  ...
  dense?: boolean;
  // New pass-through layout flags for Section
  noContainer?: boolean;
...
export default function Chapter({
  ...
  return (
    <Section
      ...
      {...(snap !== undefined ? { snap } : {})}
      {...(noContainer !== undefined ? { noContainer } : {})}
      {...(noOuterPadding !== undefined ? { noOuterPadding } : {})}
      {...(noInnerPadding !== undefined ? { noInnerPadding } : {})}
      {...(compactHeading !== undefined ? { compactHeading } : {})}
