...
export function NumberedItem({
  ...
  return (
    <li className={`flex items-start gap-3 mb-1.5 ${className}`}>
      <span className="text-[--color-foreground] font-medium text-xs shrink-0 w-[48px] md:w-[56px] text-right [font-variant-numeric:tabular-nums] [font-feature-settings:'tnum']">{num}</span>
