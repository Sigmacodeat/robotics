      ...
      <Subsection id="traction-kpis-cards" compact>
        ...
        {(!Array.isArray(kpis) || kpis.length === 0) ? (
          ...
          <div className="mx-auto grid max-w-6xl gap-4 md:gap-5 sm:grid-cols-2 lg:grid-cols-3 justify-items-center">
            ...
            <motion.div
              key={i}
              className="group w-full rounded-2xl p-5 md:p-7 ring-1 ring-[--color-border-subtle]/50 bg-[--color-surface]/60 supports-[backdrop-filter]:backdrop-blur-sm shadow-sm transition-all hover:shadow-md hover:-translate-y-0.5 hover:bg-[--color-surface]/70 text-center"
              {...(!reduceMotion ? {
            ...
            >
              ...
              {(() => {
                ...
                return (
                  <div className="mx-auto mb-2 flex h-9 w-9 items-center justify-center rounded-full ring-1 ring-[--color-border-subtle]/60 bg-[--color-surface] text-[--color-foreground-muted] group-hover:text-[--color-foreground]">
        ...
        <Subsection id="traction-kpis-trends-multi" compact className="mt-3">
          ...
          <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
            {trendsSeries.map((s, idx) => (
              <div key={idx} className="rounded-md ring-0 bg-transparent p-2">
