...
import BadgeList from '@/app/components/chapters/shared/BadgeList';
        ...
        >
          {kpiCards.map((s, idx) => (
            <InViewFade key={`${String(s.label)}-${idx}`} delay={idx * 0.05} className="h-full">
              <Card className="kpi-card kpi-card--compact kpi-card--hairline h-full rounded-2xl bg-[--color-surface]/70 shadow-sm ring-1 ring-[--color-border-subtle]/50">
                <div className="kpi-card-content relative h-full rounded-2xl p-5 md:p-7 pb-7 md:pb-8 text-center">
                  <div className="flex items-center justify-center gap-2 text-[10px] md:text-[11px] tracking-wide uppercase mb-1.5 text-[--color-foreground]">
                  ...
                  try {
                    ...
                    return (
                      <div className="mt-4 not-prose">
                        <div className="mx-auto max-w-3xl rounded-xl bg-[--color-surface]/70 ring-1 ring-[--color-border-subtle]/50 p-3 md:p-4">
