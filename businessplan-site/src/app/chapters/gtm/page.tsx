  ...
  return (
    <div className="space-y-7 md:space-y-8">
      <div className="prose prose-sm max-w-none [font-feature-settings:'ss01','ss02','liga','clig','tnum']">
        ...
        {/* Divider */}
        <div aria-hidden className="not-prose my-4 md:my-7 border-t border-zinc-600/25" />
        ...
        {/* Divider */}
        <div aria-hidden className="not-prose my-5 md:my-8 border-t border-zinc-600/20" />
          ...
          <SectionCard id="gtm-channelMix">
            ...
            {channelMix.length > 0 ? (
              <>
                ...
                <div className="mt-3 overflow-x-auto rounded-xl bg-[--color-surface] p-3 shadow-sm ring-1 ring-black/5 will-change-transform">
                  <StackedAreaAnimated
        ...
        {/* Divider */}
        <div aria-hidden className="not-prose my-4 md:my-6 border-t border-zinc-600/20" />
