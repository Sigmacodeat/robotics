const businessModel = {
  ...
  revenueStreams: [
    { type: 'RaaS Subscription', description: 'Monthly fee per robot including hardware, software license, maintenance/updates & support (SLA-tiered). Price range per robot: €3,000–€4,000 per month.' },
    { type: 'App Store Revenue Share', description: 'Revenue share: platform 30% / developers 70% (enterprise: 15% / 85%). Expected volume: 5–15% of total revenue from year 3.' }
  ],
  pricing: [
