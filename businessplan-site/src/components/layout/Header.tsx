  ...
  return (
    <header role="banner" className="sticky top-0 z-50 backdrop-blur-md bg-background/95 dark:bg-background/95 supports-[backdrop-filter]:bg-background/90 dark:supports-[backdrop-filter]:bg-background/90 print:hidden">
      <div className="container-gutter flex h-16 items-center justify-between">
        <Link href={buildLocalePath(locale, "/")} className="flex items-center gap-2 font-semibold tracking-tight" aria-label={t("homeAria", { brand: t("brand") })}>
          <Bot aria-hidden className="h-5 w-5 text-[--color-accent]" />
          <span className="flex flex-col leading-tight">
            <span className="text-sm sm:text-base font-semibold">{brandTitle}</span>
            <span className="text-[10px] sm:text-xs text-muted-foreground -mt-0.5 tracking-wide">{brandSubtitle}</span>
          </span>
        </Link>
        <nav className="flex items-center gap-1.5 sm:gap-2" aria-label={t("mainNav")}> 
          ...
          <div className="inline-flex items-center rounded border border-border overflow-hidden text-xs" role="group" aria-label={t("language")}>
            <Link
              ...
              className={`px-2 py-1.5 transition-colors ${locale === "de" ? "bg-primary text-primary-foreground" : "bg-background hover:bg-muted text-foreground"}`}
            >
              DE
            </Link>
            ...
            <Link
              ...
              className={`px-2 py-1.5 transition-colors ${locale === "en" ? "bg-primary text-primary-foreground" : "bg-background hover:bg-muted text-foreground"}`}
            >
              EN
            </Link>
          </div>
